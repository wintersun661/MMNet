...
class Evaluator:
    ...
    def __init__(self, benchmark, device):
        ...
        self.eval_buf = {
            ...
            'tss':      {'pck': [], 'cls_pck': dict()},
            'cub':      {'pck': [], 'cls_pck': dict()},
        }
    ...
    def eval_pck(self, prd_kps, data, idx):
        ...
        if self.eval_buf['cls_pck'].get(data['pair_class'][idx]) is None:
            self.eval_buf['cls_pck'][data['pair_class'][idx]] = []
        self.eval_buf['cls_pck'][data['pair_class'][idx]].append(pair_pck)
