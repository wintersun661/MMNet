...
class MMNet(nn.Module):
    def __init__(self, opt, device='cuda:0'):
        ...
        for i, k in enumerate(self.nbottlenecks):
            ...
            setattr(self, "weight_ave_"+str(i+1), WeightAverage(inner_channel))
