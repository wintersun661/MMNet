...
class MMNet(nn.Module):
    def __init__(self, opt=None, device='cuda:0'):
        ...
        elif self.backbone_name == 'resnext101':
        ...
        self.conv0_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv0_kernel = nn.Conv2d(
        ...
        self.conv1_1_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv1_2_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv1_3_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv1_kernel = nn.Conv2d(
            21, inner_channel, (3, 3), stride=1, padding=1)
        self.conv1_scale = nn.Conv2d(
            2*inner_channel, inner_channel, (3, 3), stride=1, padding=1)
        ...
        self.conv2_1_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv2_2_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv2_3_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv2_4_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv2_kernel = nn.Conv2d(
            21, inner_channel, (3, 3), stride=1, padding=1)
        self.conv2_scale = nn.Conv2d(
            2*inner_channel, inner_channel, (3, 3), stride=1, padding=1)
        ...
        self.conv3_1_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_2_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_3_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_4_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_5_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_6_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_7_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_8_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_9_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_10_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_11_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_12_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_13_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_14_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_15_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_16_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_17_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_18_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_19_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_20_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_21_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_22_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_23_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv3_kernel = nn.Conv2d(
            inner_channel, inner_channel, (3, 3), stride=1, padding=1)
        self.conv3_scale = nn.Conv2d(
            2*inner_channel, inner_channel, (3, 3), stride=1, padding=1)

        self.msblock4_1 = MSBlock(2048, rate)
        self.msblock4_2 = MSBlock(2048, rate)
        self.msblock4_3 = MSBlock(2048, rate)
        self.conv4_1_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv4_2_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv4_3_down = nn.Conv2d(32, inner_channel, (1, 1), stride=1)
        self.conv4_kernel = nn.Conv2d(
            inner_channel, inner_channel, (3, 3), stride=1, padding=1)
    ...
    def forward(self, x):
        ...
        if self.backbone_name in ["resnet101", "resnext101", 'fcn-resnet101']:
